...
public class DatabaseConnection {
    ...
    private final String url = "jdbc:mysql://127.0.0.1:3306/pao?createDatabaseIfNotExist=true&serverTimezone=UTC";
    ...
    private static void createTables(Connection connection) {
        String delimiter = ";";
        try (Scanner scanner = new Scanner(new File("src/src/Database/table.sql"))) {
